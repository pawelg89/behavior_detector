...
void BehaviorDescription::SaveBehaviorDescriptor(
    char* descriptor_name /*, int method*/) {
  int descrType = 0;
  cout << "What type of descriptor filter is it? 2-Calling for Help, 3-Faint, "
          "4-Fighting, 5-Fall, 6-Pain&Suffering, 7-Kneeling."
       << endl;
  cin >> descrType;
  char buffer[18];
